...
class _LoanFormState extends State<LoanForm> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        // Always use the maximum loan amount determined by the backend
        ...
        _errorType = result['errorType'] ?? 'other';
      });
    } else {
      _loanAmountResult = 0;
      _loanPeriodResult = 0;
              ...
              child: Column(
                children: [
                  ...
                  Slider.adaptive(
                    ...
                    min: 12,
                    max: 48, // Changed from 60 to 48
                    divisions: 36, // Changed from 40 to 36
                    ...
                    children: const [
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Align(
                            alignment: Alignment.centerRight,
                            child: Text('48 months'), // Changed from 60 to 48
                          ),
                        ),
                      )
                    ],
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _errorType == 'age_restriction' ? 
                      ...
                      child: Text(
                        _errorMessage,
                        style: _errorType == 'age_restriction' ? 
